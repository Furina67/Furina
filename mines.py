...
class MinesButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        if self.is_mine:
            ...
            await interaction.response.edit_message(content="💥 **Boom! You hit a mine!**", view=view)
            ...
            if view.safe_reveals == view.total_safe:
                ...
                await interaction.response.edit_message(content="🎉 **You cleared all safe spots! You win!**", view=view)
...
class MinesView(discord.ui.View):
    ...
    def __init__(self, size=5, mines=5):
        ...
        for x, y in positions:
            ...
            self.add_item(MinesButton(x, y, is_mine))
